...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global:		{ range: '*', href: 'css/style.css', containers: 1400, grid: { gutters: 80 } },
			wide:		{ range: '-1680', href: 'css/style-wide.css', containers: 1200, grid: { gutters: 60 } },
			normal:		{ range: '-1280', href: 'css/style-normal.css', containers: 960, viewport: { scalable: false } },
			narrow:		{ range: '-980', href: 'css/style-narrow.css', containers: '95%', grid: { gutters: 30, zoom: 3 } },
			narrower:	{ range: '-840', href: 'css/style-narrower.css', grid: { gutters: 25, zoom: 4 } },
			mobile:		{ range: '-640', href: 'css/style-mobile.css', containers: '100%', grid: { gutters: 20, zoom: 5 } }
		}
	}, {
		layers: {
